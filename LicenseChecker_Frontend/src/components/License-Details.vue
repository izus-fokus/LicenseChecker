            ...
            <q-card-section>
              <span v-for="(per, i) in license.permissions" :key="i">
                <q-list>
                  ...
                  <q-separator spaced inset></q-separator> </q-list
              ></span>
            </q-card-section>
          </q-card>
        </q-expansion-item>
...
export default {
  ...
  beforeMount: function () {
    ...
    axios
      .get(
        "http://253caac3-21ac-4f4b-be0a-076655c66384.ma.bw-cloud-instance.org:7000/api/v1/licenses/" +
